...
import static fr.omnilog.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static fr.omnilog.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static fr.omnilog.test.util.OAuth2TestUtil.testAuthenticationToken;
